...
const DEFAULT_GLOW_COLOR = '75, 46, 9'; // Dark brown glow for luxury branding
      ...
      <style>
        {`
          ...
          .card-responsive {
            ...
            margin: 0 auto;
            padding: 0.5rem;
            border: 4px solid rgba(75, 46, 9, 0.5); /* Dark brown frame, 50% opacity */
            border-radius: 24px;
        ...
        <div style={{ flex: 1, width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          {showImageEditor ? (
            ...
            <BentoCardGrid gridRef={gridRef}>
              <div className="card-responsive grid gap-2" style={{ transform: 'scale(1.2)', transformOrigin: 'center', width: '100%', marginTop: '1rem', marginBottom: '2rem', border: 'none' }}>
              ...
              return (
                ...
                >
                  ...
                  <div className="card__content flex flex-col relative text-white">
                    ...
                    <p className={`card__description text-xs leading-5 opacity-90 ${textAutoHide ? 'text-clamp-2' : ''}`} style={{ color: '#4B2E09', fontWeight: 'bold' }}>
                      {card.description}
                    </p>
                  </div>
                </div>
