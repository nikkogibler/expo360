      ...
      <div className="relative min-h-screen flex flex-col p-4 pt-10 pb-10">
        ...
        >
          ...
          <header className="text-center mb-8">
            ...
            <div className="mb-6">
              <button 
                className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition-all duration-200 flex items-center gap-2 mx-auto"
