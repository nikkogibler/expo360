...
-- Policy to allow admin users to UPDATE image_prompts (for admin operations)
...
-- Policy to allow admin users to INSERT image_prompts (for admin operations) 
CREATE POLICY "Allow admin users to insert image_prompts"
ON image_prompts
FOR INSERT
TO authenticated
WITH CHECK (
...
-- Policy to allow admin users to DELETE image_prompts (for admin operations)
CREATE POLICY "Allow admin users to delete image_prompts"
ON image_prompts
FOR DELETE
TO authenticated
USING (
